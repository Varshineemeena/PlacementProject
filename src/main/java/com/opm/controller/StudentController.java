...
//    public String deleteStudentInfo(@PathVariable Long studentId) {
//        String msg = "";
//        try {
...
//         message.setTo(student.getEmail());
//         message.setSubject("Login Alert...!!!");
//         message.setText("You're successfully logged In");
//         
...
// public String deleteCompanyInfo(@PathVariable Long id) {
//     String msg = "";
//     try {
