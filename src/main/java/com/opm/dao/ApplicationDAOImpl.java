...
//	@Override
//	    public List<Applications> getApplicationsById(Long Id) {
//	        List<Applications> applications = new ArrayList<>();
//	        try {
//	        	applications = eman.createQuery("from Applications E where E.applicationId = :applicationId").setParameter("applicationId", Id).getResultList();
//	        } catch (Exception e) {
//	            e.printStackTrace();
//	        }
//	        return applications;
